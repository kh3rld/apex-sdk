...
> {} built with [Apex SDK](https://github.com/apex-sdk/apex-sdk)
...
- [Apex SDK Documentation](https://github.com/apex-sdk/apex-sdk)
...
Built with [Apex SDK](https://github.com/apex-sdk/apex-sdk) - Unified Rust SDK for Substrate & EVM chains.
"#,
        name,
        match template {
...
📚 Resources:
   ...
   • Apex SDK Docs:    https://github.com/apex-sdk/apex-sdk
   • API Reference:    https://docs.rs/apex-sdk
   • CLI Guide:        apex --help
